package com.amusement.Mahjong.service
{
	...
	public class MahjongSyncServer20
	{
		private static var instance:MahjongSyncServer20;
		public var conn:NetConnection;

		public function MahjongSyncServer20()
		{
			connServer();
		}

		public static function getInstance():MahjongSyncServer20
		{
			if(instance == null){
				instance = new MahjongSyncServer20();
			}
			return instance;
		}
		...
		public function connServer():void
		{
			...
			conn.connect("rtmp://127.0.0.1/mahjongSyncServer20", "osroot", "", "");
		...
		private function getOnlineNumResult(obj:Object):void{
			...
			MahjongSettingControl.instance.getOnlineNum20(result);
		}
		...
		private function getAgencyEqualAndIpEqualResult(obj:Object):void{
			...
			MahjongSettingControl.instance.updateEqual20(isIpEqual, isAgencyEqual);
		}
		
		private function getTransformerStateResult(obj:Object):void
		{
			MahjongSettingControl.instance.updateMahjong20(Number(obj));
...
//			MahjongSettingControl.instance.setRoomResult(20, obj as Array);
		}
