package com.amusement.Mahjong.service
{
	...
	public class MahjongSyncServer100
	{
		private static var instance:MahjongSyncServer100;
		public var conn:NetConnection;
		
		public function MahjongSyncServer100()
		{
			connServer();
		}
		
		public static function getInstance():MahjongSyncServer100
		{
			if(instance == null){
				instance = new MahjongSyncServer100();
			}
			return instance;
		}
		...
		public function connServer():void
		{
			...
			conn.connect("rtmp://127.0.0.1/mahjongSyncServer100", "osroot", "", "");
		...
		private function getOnlineNumResult(obj:Object):void{
			...
			MahjongSettingControl.instance.getOnlineNum1(result);
		}
		...
		private function getAgencyEqualAndIpEqualResult(obj:Object):void{
			...
			MahjongSettingControl.instance.updateEqual1(isIpEqual, isAgencyEqual);
		}
		
		private function getTransformerStateResult(obj:Object):void
		{
			MahjongSettingControl.instance.updateMahjong1(Number(obj));
