...
public class NewsDAO extends HibernateDaoSupport {
	...
	public static final String PUB_PLAYER = "pubPlayer";
	...
	public List findByPubPlayer(Object pubPlayer) {
		return findByProperty(PUB_PLAYER, pubPlayer);
	}
