package com.service{
	...
	public class DataService {
		...
		public function DataService(){
			var db:File = File.applicationStorageDirectory.resolvePath("sharkData.db");
			sqlc.openAsync(db);
			...
			if(table == "player"){
				...
				if(players.length == 0){
					...
					if(bool){
						...
						PlayerService.instance.updateHaveMoney(0);
						new TimerServer();
						
						TimerServer.addPlayer(PlayerService.instance.playerName);
					}
				}
