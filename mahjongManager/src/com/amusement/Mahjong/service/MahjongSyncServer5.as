package com.amusement.Mahjong.service
{
	...
	public class MahjongSyncServer5
	{
		private static var instance:MahjongSyncServer5;
		public var conn:NetConnection;

		public function MahjongSyncServer5()
		{
			connServer();
		}

		public static function getInstance():MahjongSyncServer5
		{
			if(instance == null){
				instance = new MahjongSyncServer5();
			}
			return instance;
		}
		...
		public function connServer():void
		{
			...
			conn.connect("rtmp://127.0.0.1/mahjongSyncServer5", "osroot", "", "");
		...
		private function getOnlineNumResult(obj:Object):void{
			...
			MahjongSettingControl.instance.getOnlineNum5(result);
		}
		...
		private function getAgencyEqualAndIpEqualResult(obj:Object):void{
			...
			MahjongSettingControl.instance.updateEqual5(isIpEqual, isAgencyEqual);
		}
		
		private function getTransformerStateResult(obj:Object):void
		{
			MahjongSettingControl.instance.updateMahjong5(Number(obj));
...
//			MahjongSettingControl.instance.setRoomResult(5, obj as Array);
		}
