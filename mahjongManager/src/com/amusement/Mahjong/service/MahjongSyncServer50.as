package com.amusement.Mahjong.service
{
	...
	public class MahjongSyncServer50
	{
		private static var instance:MahjongSyncServer50;
		public var conn:NetConnection;

		public function MahjongSyncServer50()
		{
			connServer();
		}

		public static function getInstance():MahjongSyncServer50
		{
			if(instance == null){
				instance = new MahjongSyncServer50();
			}
			return instance;
		}
		...
		public function connServer():void
		{
			...
			conn.connect("rtmp://127.0.0.1/mahjongSyncServer50", "osroot", "","");
		...
		private function getOnlineNumResult(obj:Object):void{
			...
			MahjongSettingControl.instance.getOnlineNum50(result);
		}
		...
		private function getAgencyEqualAndIpEqualResult(obj:Object):void{
			...
			MahjongSettingControl.instance.updateEqual50(isIpEqual, isAgencyEqual);
		}
		
		private function getTransformerStateResult(obj:Object):void
		{
			MahjongSettingControl.instance.updateMahjong50(Number(obj));
...
//			MahjongSettingControl.instance.setRoomResult(50, obj as Array);
		}
