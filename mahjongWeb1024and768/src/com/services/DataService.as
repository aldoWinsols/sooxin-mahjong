...
//			resault(null);
			...
			for(i = 0;i < players.length; i ++){
				if(players.getItemAt(i).playerName == playerName){
					players.getItemAt(i).haveMoney = players.getItemAt(i).haveMoney + changeMoney;
					break;
				}
			}
			var arr:Array = new Array();
			...
			HomeControl.instance.home.players.dataProvider = null;
			HomeControl.instance.home.players.dataProvider = new ArrayList(arr);
		}
