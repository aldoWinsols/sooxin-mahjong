...
//			MahjongRoomControl.instance.offline(Boolean(int(contents[0])), contents[1]);
		...
		public function createRoomService(roomNo:String, roomPassword:String, enterNumber:int, maxFanNum:int, roomNum:int):void{
			//			RoomService.instance.xiao(MahjongRoomControl.instance.playerAzimuth,isZimo,isZigang);
			_conn.call("createRoomService", new Responder(resultHandler, statusHandler), this.playerName, 
				roomNo, enterNumber, roomPassword, maxFanNum, roomNum);
		}
		
		public function enterRoom(roomNo:String, password:String):void{
			//			RoomService.instance.xiao(MahjongRoomControl.instance.playerAzimuth,isZimo,isZigang);
			_conn.call("enterRoom", new Responder(resultHandler, statusHandler), this.playerName, roomNo, password);
		}
